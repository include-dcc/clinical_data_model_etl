...
desmith_global_ids <- read_csv(here::here("output", "global-descriptors-X01-deSmith.csv"))
...
```{r}
write_csv(desmith_biospecimen, here::here("output", "desmith_biospecimen_TEST.csv"))
```
