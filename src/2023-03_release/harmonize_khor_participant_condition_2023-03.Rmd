---
title: "Harmonize Khor demographic data to LinkML v2 model - March 2023"
---
...
# %>% select(participantExternalId, gender, sex)
# select(participantExternalId, race_original, race)
# select(participantExternalId, ethnicity_original, ethnicity)
```
